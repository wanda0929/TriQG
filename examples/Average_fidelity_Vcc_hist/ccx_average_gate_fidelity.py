...
Physically-motivated Rydberg-level swap relative to the
SelfCorrectingRydberg paper's worked example, based on:
...
Changes relative to the previous 'newenergy' run:
  ...
  * C_3 / C_6 coefficients swapped accordingly (Ireland et al. 2024)
  * Lattice spacing reverted to a = 5.00 um (paper value)
  * V_cc override removed; V_cc is now derived from C_6 and the lattice
  * Rydberg lifetimes updated to ARC-computed values at T = 300 K
...
#
# NB: main.tex quotes ~260 us / ~340 us for Rb 69 D_{5/2} / Cs 79 D_{5/2},
#     but ARC gives ~150 us / ~158 us for those states -- a factor ~2
#     discrepancy. We trust ARC here for internal consistency of Option A.
# ---------------------------------------------------------------------
