"""
OR Gate Simulation using mesolve (Lindblad Master Equation)
===========================================================
...
T_f = 0.32653  # Duration of target pulse half-window [us]
# Hanning pulse: area = omega_p_amp^2 * 2*T_f * (3/8) / (2*delta) = pi
# => T_f = pi * delta * 4 / (3 * omega_p_amp^2) = 0.32 us
...
fig1.tight_layout()
fig1.savefig("or_gate_mesolve_pulses.png", dpi=150)
print("Saved: or_gate_mesolve_pulses.png")
...
ax2.set_title("Population Dynamics (mesolve) — Initial: |1, 1, A>")
fig2.tight_layout()
fig2.savefig("or_gate_mesolve_populations.png", dpi=150)
print("Saved: or_gate_mesolve_populations.png")
